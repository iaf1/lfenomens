C     IVAN ALSINA FERRER
      ...
      INTEGER*4 SEED, I, J, K, L, N, ITEMP, IPAS
      PARAMETER(L=30)
      INTEGER*4 PBC(0:L+1)
      INTEGER*2 S(1:L,1:L)
      INTEGER*4 MCTOT, IMC
      ...
      REAL*8 W(-8:8)
      REAL*8 SUMA, DELTA, TEMP, ENE, DE, MAGG
      REAL*8 TEMPS(5)
      CHARACTER*32 NOM, NOMS(5)
...
C INITIAL STATE (RANDOM)
      ...
      MAGN(2) = MAGNE(S,L)
      ENE2(2) = ENERG(S,L,PBC)
      WRITE(*,*) "MAGNETITZACIONS", MAGN(1), MAGN(2)
      WRITE(*,*) "ENERGIES", ENE2(1), ENE2(2)
      WRITE(*,*) "ENERGIA MAXIMA", -2*N
      PRINT*, "======================================"

      ENDDO !#######################################FI BUCLE TEMPERATURES.
