C     IVAN ALSINA FERRER
      ...
      INTEGER*2 S(1:L,1:L)
      INTEGER*4 MCTOT
      REAL*8 GENRAND_REAL2, MAGN, MAGNE
      REAL*8 ENE,ENERG,ENEBIS
      REAL*8 TEMP
      ...
      DO I=1,10000
            CALL PROPOSECHANGE(S,L,PBC,TEMP,I)
      ENDDO
      ...
      SUBROUTINE PROPOSECHANGE(S,L,PBC,TEMP,IMC)
      IMPLICIT NONE
      INTEGER*4 L,I,J,IMC,PBC(0:L+1)
      INTEGER*2 S(1:L,1:L)
      REAL*8 GENRAND_REAL2, ENERG
